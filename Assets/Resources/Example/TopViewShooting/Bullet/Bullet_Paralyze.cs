...
//            new ActActivateTargetOperable<Movable>(trgCol, MultiState.EStateType.STURN, true);
//            new ActActivateTargetOperable<Movable>(trgCol, MultiState.EStateType.STURN, false)
//            { delay = duration };
